...
def global_level(level):
    ...
    def enemy_troop_generation():
        ...
        while loop == 1:
            ...
            enemy_troops_cost = enemy_troops[0]*1 + enemy_troops[1]*2 + enemy_troops[2]*2.5 + enemy_troops[3]*3 + enemy_troops[4]*4 + enemy_troops[5]*6
            ...
            if enemy_troops_cost < enemy_balance:
                ...
                print("enemy costs:",enemy_troops_cost)
                print("\n Done \n")
                loop = 2
...
def settings():
    print("settings")
    print("sorry there isnt any settings yet")
    loop = 1
    while loop == 1:
        settings_input = input("please press enter to continue")
        if settings_input == "":
            print("")
            loop = 2
        else:
            print("really! Are you struggling to press enter")
...
\n
to win bring the enemy health to 0
\n""")
def cheatcodes():
    print("hugo is super cool")
...
print("please go into full screen for the best experience")
print("(sorry for my bad spelling)")
while startloop:
    
    print("\nenter f to fight \n")
    print("enter s for setting\n")
    print("enter h for how to play\n")
    start_input_raw = input("input:")
